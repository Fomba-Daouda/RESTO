...
const [restaurant,setRestaurant]=useState(restaurantData)
              ...
              <View style={{height:50 , flexDirection:'row'}} >
                  ...
                  <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                        <View style={{width:'70%',height:'100%',justifyContent:'center',
                             ...
                             <Text style={{...FONTS.h4}}>{initialCurrentLocation.streetName}</Text>
                        </View>
                  </View>
                  <TouchableOpacity 
                     style={{
    ...
    const onSelectedCategory=(category)=>{
         let restaurantList = restaurantData.filter(c=>c.categories.includes(category))
         setRestaurant(restaurantList)
         setSelectedCategory(category)
         
        }
    const getCategoryNameById=(categoryID)=>{
        let cat = category.filter(a=>a.id===categoryID)
                              ...
                              <Image source={icons.star}
                                  ...
                                  
                                  {
                                      [1,2,3].map((priceRating)=>{
                                          return(
                                            <Text key={priceRating}  style={{color:(priceRating<=item.priceRating)?COLORS.black:COLORS.darkgray}}>
                                              $
                                           </Text>
                                          )
